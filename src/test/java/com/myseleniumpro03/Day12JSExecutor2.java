...
public class Day12JSExecutor2 extends TestBase {
    @Test
...
//        System.out.println(checkOutDate.getText());//returns empty string
    ...
    @Test
    public void changeBackgroundColorByJSTest() throws InterruptedException {
        driver.get("https://www.carettahotel.com/");
        Thread.sleep(3000);
    ...
    @Test
    public void changeBackgroundColorByJSTestttt() throws InterruptedException {
        driver.get("https://www.carettahotel.com/");
        Thread.sleep(3000);


        WebElement checkAvailabilityyyy = driver.findElement(By.xpath("(//div[@class='form-group p-4 align-self-stretch d-flex align-items-end'])[2]"));
        changeBackgroundColorByJS(checkAvailabilityyyy, "orange");
    }
    @Test
